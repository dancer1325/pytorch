...
* PyTorch
  * == Python package 
    * MAIN high-level features
      - Tensor computation (like NumPy) / strong GPU acceleration
      - Deep neural networks / built | tape-based autograd system
    * can be extended -- reusing -- your favorite Python packages (NumPy, SciPy, Cython, ...)
  * [trunk health (CI dashboard)](https://hud.pytorch.org/ci/pytorch/pytorch/main) 
